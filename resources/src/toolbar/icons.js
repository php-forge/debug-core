/**
 * Inline glyph inventory served as data URLs, keyed by icon name.
 *
 * Exported so `tools/check-icons.mjs` can compare every entry with the SVG file
 * of the same name under `resources/assets/svg/`, which PHP `Helper\Icon`
 * serves to the panel pages.
 */
export const builtinIcons = Object.freeze({
  ...
  dots: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><circle cx="5" cy="12" r="2.2"/><circle cx="12" cy="12" r="2.2"/><circle cx="19" cy="12" r="2.2"/></svg>',
