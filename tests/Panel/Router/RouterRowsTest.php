...
use PHPForge\Debug\Panel\Router\{ActionRouteRow, CurrentRouteLogRow, RouterRuleRow};
...
final class RouterRowsTest extends TestCase
{
    ...
    public function testCurrentRouteLogRowIsBuiltOnlyFromLiteralBooleanMatch(): void
    {
        ...
        self::assertNotNull(
            $matched,
            'A literal boolean match yields a row.',
        );
        self::assertTrue(
            $matched->match,
    ...
    public function testCurrentRouteLogRowParentFallsBackToEmptyWhenMissing(): void
    {
        ...
        self::assertNotNull(
            $row,
            'A well-formed payload yields a row.',
        );
        self::assertSame(
            'app\\rules\\Home',
            $row->rule,
        ...
        self::assertSame(
            '',
            $row->parent,
            'A missing parent must fall back to an empty string.',
        );
    }
