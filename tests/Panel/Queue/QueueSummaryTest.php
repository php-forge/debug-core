...
use PHPForge\Debug\Panel\Queue\{JobRecord, QueueSnapshot, QueueSummary};
 ...
 * {@see \PHPForge\Debug\Panel\Queue\QueueSummary} aggregates.
 */
#[Group('panel')]
#[Group('queue')]
final class QueueSummaryTest extends TestCase
{
    public function testCaptureDropsRecordsThatAreNotArrays(): void
    {
        ...
        self::assertSame(
            1,
            $summary->totalPushed(),
            'Only the explicit push survives.',
        );
    }
