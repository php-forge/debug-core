...
final class InstrumentationGuardTest extends TestCase
{
    public function testObserveExecutesSuccessfulObserver(): void
    {
        ...
        self::assertTrue(
            $observed,
            'A successful diagnostic observer must run exactly where invoked.',
        );
    }
    ...
    public function testObserveReportsExactFailureWithoutPropagatingIt(): void
    {
        ...
        self::assertSame(
            $expected,
            $reported,
            'The failure handler must receive the exact instrumentation throwable.',
        );
    }
