...
/**
 * Normalizes the narrowed payload of the Configuration panel into a typed {@see ConfigSummary} tree.
 */
final class ConfigDataNormalizer
{
     ...
     * @param array<string, string> $extensions Already-typed roster from the Configuration panel extension roster.
     *
